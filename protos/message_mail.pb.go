...
var file_message_mail_proto_rawDesc = string([]byte{
	...
	0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x69, 0x74, 0x68, 0x69,
	0x6c, 0x62, 0x6f, 0x72, 0x2f, 0x78, 0x69, 0x72, 0x61, 0x69, 0x64, 0x5f, 0x65, 0x78, 0x70, 0x6f,
	0x72, 0x74, 0x65, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
})

var (
	file_message_mail_proto_rawDescOnce sync.Once
	file_message_mail_proto_rawDescData []byte
)

func file_message_mail_proto_rawDescGZIP() []byte {
	file_message_mail_proto_rawDescOnce.Do(func() {
		file_message_mail_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_message_mail_proto_rawDesc), len(file_message_mail_proto_rawDesc)))
	})
	return file_message_mail_proto_rawDescData
}

var file_message_mail_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_message_mail_proto_goTypes = []any{
...
func file_message_mail_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_message_mail_proto_rawDesc), len(file_message_mail_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
