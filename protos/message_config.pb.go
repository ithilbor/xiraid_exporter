...
var file_message_config_proto_rawDesc = []byte{
	...
	0x69, 0x72, 0x6f, 0x6e, 0x63, 0x75, 0x62, 0x33, 0x2f, 0x78, 0x69, 0x72, 0x61, 0x69, 0x64, 0x5f,
...
var (
	...
	file_message_config_proto_rawDescData = file_message_config_proto_rawDesc
)

func file_message_config_proto_rawDescGZIP() []byte {
	file_message_config_proto_rawDescOnce.Do(func() {
		file_message_config_proto_rawDescData = protoimpl.X.CompressGZIP(file_message_config_proto_rawDescData)
	})
	return file_message_config_proto_rawDescData
}

var file_message_config_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_message_config_proto_goTypes = []interface{}{
...
func file_message_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_config_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigApply); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_config_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigBackup); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_config_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigRestore); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_config_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ConfigShow); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_message_config_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_message_config_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_message_config_proto_rawDesc = nil
