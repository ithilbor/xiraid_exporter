...
var file_message_drive_proto_rawDesc = []byte{
...
var (
	...
	file_message_drive_proto_rawDescData = file_message_drive_proto_rawDesc
)

func file_message_drive_proto_rawDescGZIP() []byte {
	file_message_drive_proto_rawDescOnce.Do(func() {
		file_message_drive_proto_rawDescData = protoimpl.X.CompressGZIP(file_message_drive_proto_rawDescData)
	})
	return file_message_drive_proto_rawDescData
}

var file_message_drive_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_message_drive_proto_goTypes = []interface{}{
...
func file_message_drive_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_drive_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DriveClean); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_drive_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DriveFaultyCountReset); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_drive_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DriveFaultyCountShow); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_drive_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*DriveLocate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_message_drive_proto_msgTypes[2].OneofWrappers = []interface{}{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_message_drive_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_message_drive_proto_rawDesc = nil
