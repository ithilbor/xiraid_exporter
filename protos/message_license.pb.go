...
var file_message_license_proto_rawDesc = []byte{
...
var (
	...
	file_message_license_proto_rawDescData = file_message_license_proto_rawDesc
)

func file_message_license_proto_rawDescGZIP() []byte {
	file_message_license_proto_rawDescOnce.Do(func() {
		file_message_license_proto_rawDescData = protoimpl.X.CompressGZIP(file_message_license_proto_rawDescData)
	})
	return file_message_license_proto_rawDescData
}

var file_message_license_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_message_license_proto_goTypes = []interface{}{
...
func file_message_license_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_message_license_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LicenseDelete); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_license_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LicenseShow); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_message_license_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LicenseUpdate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_message_license_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_message_license_proto_rawDesc = nil
